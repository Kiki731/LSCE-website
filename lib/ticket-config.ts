...
export const TICKET_TYPES: Record<TicketTier, TicketType> = {
  bronze: {
    ...
    price: 4000,
    priceKobo: 400000,
    tagline: 'The essential pass to get you in the room',
    description:
  ...
  silver: {
    ...
    price: 8000,
    priceKobo: 800000,
    tagline: 'Level up your expo experience',
    description:
  ...
  gold: {
    id: 'gold',
    name: 'The Emergence',
    price: 0,          // Strictly by invite — not purchasable
    priceKobo: 0,
    tagline: 'Strictly by Invite',
    description:
